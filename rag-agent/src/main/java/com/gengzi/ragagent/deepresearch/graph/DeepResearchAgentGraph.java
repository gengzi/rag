package com.gengzi.ragagent.deepresearch.graph;
...
import com.gengzi.ragagent.deepresearch.dispathcher.CoordinatorDispatcher;
import com.gengzi.ragagent.deepresearch.node.CoordinatorNode;
...
public class DeepResearchAgentGraph {
    ...
    public StateGraph deepResearch(ChatClient researchAgent) throws GraphStateException {
        ...
        stateGraph.addEdge(START, "CoordinatorNode")
                ...
                .addEdge("rewrite_multi_query", END);
