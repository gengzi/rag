package com.gengzi.ragagent.service.impl;
...
import com.gengzi.ragagent.deepresearch.process.DeepResearchGraphProcess;
import com.gengzi.ragagent.request.RagChatReq;
import com.gengzi.response.ChatMessageResponse;
import com.gengzi.ragagent.service.DeepResearchService;
...
public class DeepResearchServiceImpl implements DeepResearchService {
    ...
    public DeepResearchServiceImpl(StateGraph deepResearch) throws GraphStateException {
        // 记忆缓存类
        ...
        this.compiledGraph = deepResearch
     ...
     */
    @Override
    public Flux<ServerSentEvent<ChatMessageResponse>> deepResearch(RagChatReq req) {
