...
public class MSimpleLoggerAdvisor implements CallAdvisor, StreamAdvisor {
    ...
    public MSimpleLoggerAdvisor(@Nullable Function<ChatClientRequest, String> requestToString, @Nullable Function<ChatResponse, String> responseToString, int order) {
    ...
    protected void logResponse(ChatClientResponse chatClientResponse) {
        logger.info("response: {}", JSONUtil.toJsonStr(chatClientResponse.chatResponse()));
    }
